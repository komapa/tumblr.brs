...
Sub Main()
    ...
    ' Initialize once: use global m scope as singleton pattern for oa and tumblr
    ...
    ' You can create a tumblr developer account and register your app to get the consumerkey and consumersecret
    m.oa = InitOauth("Roku", "H27CkELzuDphxzvVmcNe3l4rQ7Qs4MJgxzRYOKJbIKyi69CsEx", "RGcxstFgMoMFYdXBhzQGqIZrScZGh16mBZXd9Fq24zfypK6qLM", "1.0")
    m.tumblr = InitTumblr()
